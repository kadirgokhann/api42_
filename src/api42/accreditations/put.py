...
def put_accreditations(self, id: int = None, name: str = None, user_id: int = None, cursus_id: int = None, validated: bool = None, difficulty: int = None, skill_id: int = None, value: int = None, destroy: str = None):
    """
    ...
    204 
    """
    _params = {"id": id, "name": name, "user_id": user_id, "cursus_id": cursus_id,
    ...
    for k, v in _params.items():
        ...
        params[k] = v
    #########################
    response = self.request("put", "/v2/accreditations", params=params)
    ############################
    return response
